...
function InGameScene(mainGame)
{
    ...
    this._autoStopBtn=null;
    this._autoTicker=null;
...
InGameScene.prototype._createButtonGroup = function() {
    ...
    this._autoStopBtn = new xqu.pixi.SimpleButton("autostop_button",
        TextureCache['autoPlayStop_unroll.png'],
    ...
    this._container.addChild(this._autoStopBtn.getTransform());
    this._autoStopBtn.addEventListener('click', new xqu.Callback(self._onClickAutoStopBtn, self));
    ...
    /*this._autoTicker.add(function(time){
      if(this._playAgainBtn.getTransform().visible==true){
        ...
        this._autoStopBtn.setVisible(false);
        this._autoStopBtn.setEnable(false);
      }
    });*/
...
InGameScene.prototype._setstoptimer = function (autoticker,playagainbtn,autoplaybtn) {
...
InGameScene.prototype._autoPlay_cb_startMainGame = function(playLeftAmount) {
  ...
  this._autoPlayBtn.setEnable(false);
  this._autoPlayBtn.setVisible(false);
  this._autoStopBtn.setEnable(true);
  this._autoStopBtn.setVisible(true);
